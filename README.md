...
- `프로젝트_보고서.pdf`: 기능 설명 및 설계 문서
- `발표자료.pdf`: 프로젝트 소개용 발표 자료

---

## ▶️ 실행 방법

현재는 사용자 로그인 기능이 없으며, Spotify Web API에서 토큰을 발급받아 수동으로 입력해야 합니다.  
`server.py` 파일의 `client_id`, `client_secret` 값을 아래와 같이 수정해주세요:
